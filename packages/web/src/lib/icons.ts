...
export const ICONS: Record<string, string> = {
  ...
  /* Account-kind glyphs — the same Lucide names the reference app's accountables use, so a
     kind reads identically in both apps (see KIND_STYLE in accountMeta.ts). */
